...
import com.org.core.java.demo.model.Employee;
...
public class GroupingByMultipleFieldsExample {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Map<String, Long>> multipleFieldsMap = employeesList.stream().collect(
                Collectors.groupingBy(Employee::getDesignation, Collectors.groupingBy(Employee::getGender, Collectors.counting())));

        // printing the count based on the designation and gender.
        System.out.println("\n Example1 Group by on multiple properties" + multipleFieldsMap + "\n");
        ...
        // printing the count based on the designation and gender.
        System.out.println("\n Example2 Group by on multiple properties and Map key as List" + multipleFieldsMapList + "\n");
    }
}